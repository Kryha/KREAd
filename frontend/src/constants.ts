...
export const SUCCESSFUL_MINT_REPONSE_MSG =
  "Character mint successful, use attached public facet to purchase" as const;
export const SELL_CHARACTER_DESCRIPTION =
  "Sell Character in KREAd marketplace" as const;
...
export const STORAGE_NODE_SPEC_MARKET_ITEMS =
  ":published.kread.market-items" as const;
export const STORAGE_NODE_SPEC_MARKET_CHARACTERS =
  ":published.kread.market-characters" as const;

export const STORAGE_NODE_SPEC_INVENTORY =
  ":published.kread.inventory-" as const;
...
export type InteractionMode =
  | typeof ITEM_MODE
  | typeof MAIN_MODE
  | typeof CATEGORY_MODE
  | typeof CHARACTER_SELECT_MODE;
...
export const localBridgeHref =
  "http://localhost:3000/wallet/bridge.html" as const;
export const prodBridgeHref =
  "https://wallet.agoric.app/wallet/bridge.html" as const;
export const devBridgeHref =
  "https://main.wallet-app.pages.dev/wallet/bridge.html" as const;
...
export const AGORIC_RPC =
  import.meta.env.VITE_RPC || ("http://127.0.0.1:26657" as const);

export const INVENTORY_CALL_FETCH_DELAY = 10000 as const;

export const PINATA_GATEWAY =
  import.meta.env.VITE_PINATA_GATEWAY ||
  "https://pink-defensive-jay-557.mypinata.cloud";
