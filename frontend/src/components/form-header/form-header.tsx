...
import { BUY_FLOW_STEPS, CONFIRMATION_STEP, INFORMATION_STEP, PAYMENT_STEP, SELL_FLOW_STEPS } from "../../constants";
  ...
  return (
    <>
      ...
      <FormNavigation>
        {!isBuyFlow && (
          <NavigationTab>
            <FormTab active={currentStep === INFORMATION_STEP} title={text.mint.information} amount={BUY_FLOW_STEPS} />
          </NavigationTab>
        )}
        <NavigationTab>
