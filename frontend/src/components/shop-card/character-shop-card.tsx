...
export const CharacterShopCard: FC<CharacterShopCardProps> = ({
  character,
  onClick,
}) => {
    ...
    >
      <Content>
        <ImageContainer>
          <Element />
          <BaseCharacter
            characterImage={character.character.image}
        ...
        <InfoContainer>
          <TitleWrapper>
            ...
            <BoldLabel>
              {text.param.categories[character.character.type]}
            </BoldLabel>
          </TitleWrapper>
          <Footer>
            <Tag>
              <BoldLabel customColor={color.black}>
                {text.param.level(character.character.level)}
              </BoldLabel>
            </Tag>
            <PriceContainer>
