export const notifications = {
  ...
  butYouCanAlwaysAccept: "but you can always accept the offer in your wallet. When accepted, you'll see the newly minted character appearing in the 'My characters' menu.",
