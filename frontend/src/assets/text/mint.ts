export const mint = {
  ...
  theCostsOfMinting: "the costs of minting a new character are  RUN 2,00. Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada.",
  next: "next",
  confirm: "confirm",
