    ...
    },
    {
      ...
      item: {
        ...
        async mintDefaultBatch(seat) {
          ...
          const index3 = Math.floor(helper.randomNumber() * commonBases.length);
          const item3 = commonBases[index3];
          ...
          const index4 = Math.floor(
            helper.randomNumber() * uncommonToLegendary.length,
          );
          const item4 = uncommonToLegendary[index4];
